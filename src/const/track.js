...
const trackDict = Object.freeze({
  ...
  bMG: makeTrack('Wii キノコキャニオン', 'bMG', 135829, 'https://youtu.be/Xfpt33fPX2Q?si=7ptyhmNWBKu3MijQ', 135829, ['キノキャニ', 'キノコキャニオン', 'MG']),
  ...
  bBL: makeTrack('GBA テレサレイク', 'bBL', 123262, 'https://youtu.be/CvQc3OaqCio?si=9GZsp6nQf_O4mPpA', 123170, ['テレレ', 'テレサレイク', 'レイク', 'BL']),
  ...
  bBC3: makeTrack('SFC クッパじょう3', 'bBC3', 143114, 'https://www.youtube.com/watch?v=d5ydfEfO55Y', 143085, ['クッパじょう', 'クッパ城', 'クッパ城3', 'クッパじょう3', 'BC3']),
