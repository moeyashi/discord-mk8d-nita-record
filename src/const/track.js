...
const trackDict = Object.freeze({
  ...
  TR: makeTrack('ドッスンいせき', 'TR', 152742, 152636, ['遺跡', 'ドッスン', 'いせき', 'ドッスン遺跡']),
  MC: makeTrack('マリオサーキット', 'MC', 148538, 148222, ['新マリサ', 'しんマリサ']),
  TH: makeTrack('キノピオハーバー', 'TH', 205466, 205466, ['ハーバー']),
  TM: makeTrack('ねじれマンション', 'TM', 158878, 158447, ['ねじマン', 'ねじれ']),
  SGF: makeTrack('ヘイホーこうざん', 'SGF', 159079, 159079, ['ヘイホー鉱山', 'ヘイこう', 'こうざん']),
  SA: makeTrack('サンシャインくうこう', 'SA', 200913, 200498, ['サンシャイン空港', '空港', 'くうこう']),
  ...
  rMMM: makeTrack('Wii モーモーカントリー', 'rMMM', 127217, 127217, ['Wiiモーモーカントリー', 'モモカン', 'モーモーカントリー', 'MMM']),
  rMC: makeTrack('GBA マリオサーキット', 'rMC', 127355, 127355, ['GBAマリオサーキット', 'グバマリ', 'GBAマリサ']),
  rCCB: makeTrack('DS プクプクビーチ', 'rCCB', 149767, 149698, ['プクプクビーチ', 'プクビ', 'プクプク', 'CCB']),
  ...
  dAC: makeTrack('どうぶつの森', 'dAC', 142777, 142590, ['どうぶつのもり', 'どうもり', 'どう森', 'AC']),
  ...
  bNYM: makeTrack('Tour ニューヨークドリーム', 'bNYM', 124890, 124890, ['ニューヨーク', 'ニューヨークドリーム', 'NYM', 'NY']),
  ...
  bSHS: makeTrack('アイスビルディング', 'bSHS', 156913, 155364, ['アイス', 'アイビル', 'SHS']),
  bLL: makeTrack('Tour ロンドンアベニュー', 'bLL', 212503, 211833, ['ロンドン', 'ロンドンアベニュー', 'アベニュー', 'LL']),
  ...
  bRR7: makeTrack('3DS レインボーロード', 'bRR7', 138885, 138885, ['3DSレインボーロード', '7虹', '7にじ', '7レインボー', '3DSレインボー', '3DS虹', '3DSにじ', 'RR7']),
  ...
  bDCt: makeTrack('Wii デイジーサーキット', 'bDCt', 150966, 150966, ['デイサ', 'デイジーサーキット', 'デジサ', 'DCt']),
  ...
  bRRw: makeTrack('Wii レインボーロード', 'bRRw', 234877, 234363, ['Wiiレインボーロード', 'Wii虹', 'Wiiにじ', 'Wiiレインボー', 'RRw']),
});
