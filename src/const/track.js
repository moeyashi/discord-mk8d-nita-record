...
const trackDict = Object.freeze({
  ...
  rWS: makeTrack('DS ワリオスタジアム', 'rWS', 152704, 'https://www.youtube.com/live/oTbS_RASaZA?t=6724', 152687, ['ワリスタ', 'ワリオスタジアム', 'WS']),
  rSL: makeTrack('GC シャーベットランド', 'rSL', 150154, 'https://youtu.be/RljGPuZk1o0?si=ysK8ns6-OwVs0BoM', 149804, ['シャベラン', 'シャーベットランド', 'SL']),
  rMP: makeTrack('3DS ミュージックパーク', 'rMP', 152921, 'https://youtu.be/pGk4rYtghA4?si=ZrL8FAhYe1swzbHs', 152021, ['ミューパ', 'ミュージックパーク', 'MP']),
  ...
  dSBS: makeTrack('リンリンメトロ', 'dSBS', 144528, 'https://youtu.be/tHLa4FdaP4M', 144196, ['リンメト', 'SBS']),
  ...
  bKD: makeTrack('N64 カラカラさばく', 'bKD', 133567, 'https://youtu.be/a57x-oiqadM?si=hcYeEzIdKDNUIfNu', 133480, ['N64カラカラさばく', '64カラカラさばく', '64カラサバ', 'KD']),
  ...
  bMM: makeTrack('Tour メリーメリーマウンテン', 'bMM', 156910, 'https://youtu.be/gk1A6m06wqY?si=gy45oYeWmUZ1Gx-b', 155717, ['メリマ', 'メリーメリーマウンテン', 'メリマン', 'MM']),
  ...
  bDKS: makeTrack('Wii DKスノーボードクロス', 'bDKS', 157595, 'https://youtu.be/KwmJHj8kvfg?si=AeLoKUfWAb4ZZBIh', 157595, ['スノボ', 'DKスノーボードクロス', 'スノーボードクロス', 'DKS', 'DKS01', '01']),
  ...
  bWS: makeTrack('GC ワルイージスタジアム', 'bWS', 157607, 'https://youtu.be/9_8HOl0ds-8?si=HcXA7qJiNxro4A_X', 156748, ['ワルスタ', 'ワルイージスタジアム']),
  ...
  bDCt: makeTrack('Wii デイジーサーキット', 'bDCt', 150865, 'https://youtu.be/Ma0g61nhXw4?si=fDYMju2sPIvUF9jS', 150638, ['デイサ', 'デイジーサーキット', 'デジサ', 'DCt']),
