...
const trackDict = Object.freeze({
  ...
  MC: makeTrack('マリオサーキット', 'MC', 148005, 'https://youtu.be/38PFGM94xfo', 148005, ['新マリサ', 'しんマリサ']),
  ...
  rDP3: makeTrack('SFC ドーナツへいや3', 'rDP3', 117640, 'https://youtu.be/ZSfssw5QDcM', 117640, ['ドーナツへいや3', '平野', 'へいや', 'SFCドーナツへいや3', 'ドーナツへいや', 'ドーナツ平野', 'DP3']),
  ...
  rPPS: makeTrack('3DS パックンスライダー', 'rPPS', 203237, 'https://youtu.be/Yov_bvZ0scA', 202676, ['パクスラ', 'パックンスライダー', 'PPS']),
  ...
  bNH: makeTrack('Tour ニンニンドージョー', 'bNH', 153996, 'https://youtu.be/NkuSxjTFNi4', 153645, ['ニンニン', 'ニンニンドージョー', 'NH']),
  ...
  bWP: makeTrack('DS ワルイージピンボール', 'bWP', 220795, 'https://youtu.be/ilcauh-07H4', 220795, ['ワルピン', 'ワルイージピンボール']),
  ...
  bMC: makeTrack('DS マリオサーキット', 'bMC', 141878, 'https://youtu.be/QN0oK_u2ETk', 141878, ['DSマリサ', 'DSマリオサーキット']),
  ...
  bSW: makeTrack('GBA サンセットこうや', 'bSW', 137096, 'https://youtu.be/gaxyww0xDGw', 137096, ['サンセット', 'こうや', 'サンセット荒野', 'サンセットこうや', 'SW']),
  ...
  bDKM: makeTrack('GC DKマウンテン', 'bDKM', 210859, '', 210859, ['DKマウンテン', 'DK山', 'DKM']),
