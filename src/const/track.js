...
const trackDict = Object.freeze({
  ...
  bWP: makeTrack('DS ワルイージピンボール', 'bWP', 220832, 'https://www.youtube.com/watch?v=jtlc-CgGd9U', 220795, ['ワルピン', 'ワルイージピンボール']),
  ...
  bDKM: makeTrack('GC DKマウンテン', 'bDKM', 211830, 'https://www.youtube.com/watch?v=WaheDErFJdM', 211830, ['DKマウンテン', 'DK山', 'DKM']),
