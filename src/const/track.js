...
const trackDict = Object.freeze({
  ...
  rCCB: makeTrack('DS プクプクビーチ', 'rCCB', 149496, 'https://youtu.be/vjHi-WoBcHE?si=9CD9hQYtUyB4Br_8', 149496, ['プクプクビーチ', 'プクビ', 'プクプク', 'CCB']),
  ...
  dRiR: makeTrack('GBA リボンロード', 'dRiR', 150840, 'https://youtu.be/R4B2TsJUdWY', 150681, ['リボン', 'リボロ', 'リボンロード', 'RiR']),
  ...
  bTB: makeTrack('Tour トーキョースクランブル', 'bTB', 127758, 'https://youtu.be/0v3eEQSZjmw', 127522, ['東京', 'トウキョウ', 'トウキョウスクランブル', 'トーキョー', 'トーキョースクランブル', 'TB']),
  ...
  bSSy: makeTrack('Tour シンガポールスプラッシュ', 'bSSy', 158177, 'https://www.youtube.com/watch?v=Mq_q0NU1huY&t=151s', 158177, ['シンガポール', 'シンガポールスプラッシュ', 'SSy']),
