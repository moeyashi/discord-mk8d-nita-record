...
const trackDict = Object.freeze({
  ...
  bSR: makeTrack('DS キノコリッジウェイ', 'bSR', 147773, 'https://youtu.be/KxQNcJuGxfA?si=yy6kfNc8CgoGblCh', 147773, ['リッジウェイ', 'キノコリッジウェイ', 'キノコリッジ', 'リッジ', 'SR']),
  ...
  bLL: makeTrack('Tour ロンドンアベニュー', 'bLL', 211544, 'https://youtu.be/LriFQ4bJBrA?si=IS7O-UhDMzdCYAXG', 211465, ['ロンドン', 'ロンドンアベニュー', 'アベニュー', 'LL']),
  bBL: makeTrack('GBA テレサレイク', 'bBL', 123262, 'https://youtu.be/CvQc3OaqCio?si=9GZsp6nQf_O4mPpA', 123010, ['テレレ', 'テレサレイク', 'レイク', 'BL']),
  ...
  bDKS: makeTrack('Wii DKスノーボードクロス', 'bDKS', 156894, 'https://youtu.be/VnYnuESwbZo?si=-A-yjsjld9Rq-HzZ', 156894, ['スノボ', 'DKスノーボードクロス', 'スノーボードクロス', 'DKS', 'DKS01', '01']),
  ...
  bRA: makeTrack('Tour ローマアバンティ', 'bRA', 147174, 'https://youtu.be/0FD76oWpvvQ?si=Z2fl70x5YypRIsMu', 147173, ['ローマ', 'ローマアバンティ', 'RA']),
  bDKM: makeTrack('GC DKマウンテン', 'bDKM', 210859, 'https://x.com/kuzerox_/status/1781224866592796702?s=46&t=n_XfioWCbx56plliCg1BSA', 209906, ['DKマウンテン', 'DK山', 'DKM']),
  bDCt: makeTrack('Wii デイジーサーキット', 'bDCt', 150638, 'https://youtu.be/4lBt8f9s52Q?si=xYzo4ebOLNK-bya5', 150456, ['デイサ', 'デイジーサーキット', 'デジサ', 'DCt']),
  ...
  bRIW: makeTrack('3DS ロゼッタプラネット', 'bRIW', 159866, 'https://youtu.be/ENIvSOTo9iY?si=IR2YqvCs8QALqmlk', 159739, ['ロゼプラ', 'ロゼッタプラネット', 'RIW']),
