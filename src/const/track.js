...
const trackDict = Object.freeze({
  ...
  TH: makeTrack('キノピオハーバー', 'TH', 204894, 'https://www.youtube.com/watch?v=p6ZN3n349Xc', 204858, ['ハーバー']),
  ...
  bWP: makeTrack('DS ワルイージピンボール', 'bWP', 220795, 'https://youtu.be/ilcauh-07H4?si=11WsqNBl9s29CXJe', 220341, ['ワルピン', 'ワルイージピンボール']),
  ...
  bRIW: makeTrack('3DS ロゼッタプラネット', 'bRIW', 159970, 'https://www.youtube.com/watch?v=QbdeIpuHCEc', 159866, ['ロゼプラ', 'ロゼッタプラネット', 'RIW']),
