...
const trackDict = Object.freeze({
  ...
  bMC3: makeTrack('SFC マリオサーキット3', 'bMC3', 135794, 'https://youtu.be/TWnbD54vew8?si=er35cWckglMzMKM2', 135695, ['SFCマリオサーキット3', 'SFCマリオサーキット', 'マリオサーキット3', 'マリサ3', 'SFCマリサ', 'SFCマリサ3', 'MC3']),
