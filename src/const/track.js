...
const trackDict = Object.freeze({
  ...
  rTT: makeTrack('N64 キノピオハイウェイ', 'rTT', 147879, 'https://youtu.be/cXGUurTFL4Y', 147148, ['ハイウェイ', 'キノピオハイウェイ', 'TT']),
  ...
  bRR7: makeTrack('3DS レインボーロード', 'bRR7', 138705, 'https://youtu.be/y1eKyKlghB0?si=1HrienBUNKvXod6F', 138440, ['3DSレインボーロード', '7虹', '7にじ', '7レインボー', '3DSレインボー', '3DS虹', '3DSにじ', 'RR7']),
