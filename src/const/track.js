...
const trackDict = Object.freeze({
  ...
  rWS: makeTrack('DS ワリオスタジアム', 'rWS', 152760, 'https://www.youtube.com/watch?v=1h-9ea5fA9Q', 152687, ['ワリスタ', 'ワリオスタジアム', 'WS']),
  ...
  bKD: makeTrack('N64 カラカラさばく', 'bKD', 133700, 'https://youtu.be/53aZavl4l10?si=DLnDdiGezFNiVjGg', 133627, ['N64カラカラさばく', '64カラカラさばく', '64カラサバ', 'KD']),
  ...
  bWS: makeTrack('GC ワルイージスタジアム', 'bWS', 157607, 'https://youtu.be/9_8HOl0ds-8?si=HcXA7qJiNxro4A_X', 157379, ['ワルスタ', 'ワルイージスタジアム']),
