...
const trackDict = Object.freeze({
  ...
  WP: makeTrack('ウォーターパーク', 'WP', 141327, 'https://youtu.be/EBg0Zw73qak?si=hkdsMaJ9677jteIl', 141163, ['ウォタパ']),
  ...
  rCCB: makeTrack('DS プクプクビーチ', 'rCCB', 149466, 'https://youtu.be/MsgA7Avo37g?si=kLkwVGCkpszUEcWE', 149466, ['プクプクビーチ', 'プクビ', 'プクプク', 'CCB']),
  rTT: makeTrack('N64 キノピオハイウェイ', 'rTT', 147954, 'https://youtu.be/nJrzUis5N7Q', 147148, ['ハイウェイ', 'キノピオハイウェイ', 'TT']),
  ...
  dBB: makeTrack('ビッグブルー', 'dBB', 126146, 'https://youtu.be/LF9VanxJo2k?si=J1MIZqposH444_vk', 125983, ['BB', 'ビックブルー']),
  ...
  bSR: makeTrack('DS キノコリッジウェイ', 'bSR', 147948, 'https://www.youtube.com/watch?v=en1juGwAi0s', 147929, ['リッジウェイ', 'キノコリッジウェイ', 'キノコリッジ', 'リッジ', 'SR']),
  ...
  bRR7: makeTrack('3DS レインボーロード', 'bRR7', 138800, 'https://youtu.be/-vqJrj46G9I?si=veo0HNYC3ftaR8HC', 138440, ['3DSレインボーロード', '7虹', '7にじ', '7レインボー', '3DSレインボー', '3DS虹', '3DSにじ', 'RR7']),
  ...
  bYI: makeTrack('ヨッシーアイランド', 'bYI', 200383, 'https://youtu.be/jppgF_EHNeE?si=Uiigoz0i9eVoytuQ', 200383, ['ヨシアイ', 'YI']),
  ...
  bMH: makeTrack('Wii ムーンリッジ＆ハイウェイ', 'bMH', 144738, 'https://youtu.be/5_abvL9pxz4?si=gzXDZN9DLZsadSa6', 144595, ['ムーンリッジ＆ハイウェイ', 'ムーンリッジ', 'ムーンリッジハイウェイ', 'ムンリ', 'MH', '月']),
