...
const trackDict = Object.freeze({
  ...
  rRRd: makeTrack('N64 レインボーロード', 'rRRd', 121195, 120766, ['N64レインボーロード', 'N64レインボー', 'N64虹', 'N64にじ', '64虹', '64にじ', '64レインボー', 'RRd']),
  ...
  bMC3: makeTrack('SFC マリオサーキット3', 'bMC3', 135884, 135884, ['SFCマリオサーキット', 'マリサ3', 'SFCマリサ', 'SFCマリサ3', 'MC3']),
  ...
  bMH: makeTrack('Wii ムーンリッジ＆ハイウェイ', 'bMH', 144765, 144595, ['ムーンリッジ＆ハイウェイ', 'ムーンリッジ', 'ムーンリッジハイウェイ', 'ムンリ', 'MH']),
