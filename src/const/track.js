...
const trackDict = Object.freeze({
  ...
  MC: makeTrack('マリオサーキット', 'MC', 147877, 'https://youtu.be/nI-TvVqODEg?si=OjTHKWHG5YiTKbn2', 147172, ['新マリサ', 'しんマリサ']),
  ...
  BDD: makeTrack('ホネホネさばく', 'BDD', 150839, 'https://youtu.be/eDYuoQoS50c?si=EGKRes3ZGQpzasEI', 150839, ['ホネサバ', 'ホネホネ', 'ホネホネ砂漠']),
  BC: makeTrack('クッパキャッスル', 'BC', 201850, 'https://youtu.be/QZC9-o-_uSg?si=Xwj-160KBEZR12u4', 201850, ['クパキャ']),
  ...
  rCCB: makeTrack('DS プクプクビーチ', 'rCCB', 149203, 'https://youtu.be/HvHa8c-IDgA?si=qj5M1bcCb-y068ov', 149203, ['プクプクビーチ', 'プクビ', 'プクプク', 'CCB']),
  ...
  rYV: makeTrack('N64 ヨッシーバレー', 'rYV', 202579, 'https://youtu.be/rk4_FAUauEc?si=w4U3bYednyINLu3s', 202140, ['ヨシバ', 'ヨッシーバレー', 'YV']),
  ...
  dYC: makeTrack('GC ヨッシーサーキット', 'dYC', 145908, 'https://youtu.be/bs2t5JLy5TU?si=zswmMmxCMLSDQE8G', 145118, ['ヨシサ', 'ヨッシーサーキット', 'YC']),
  dEA: makeTrack('エキサイトバイク', 'dEA', 142433, 'https://youtu.be/pX-S1bz-I5M?si=mh3blQ3VPj7VH4M1', 142433, ['エキバ', 'EA']),
  dDD: makeTrack('ドラゴンロード', 'dDD', 145516, 'https://youtu.be/p29GFsD2ahI?si=fqHpUzriRd-Ii_Ao', 144976, ['ドラロ', 'DD']),
  dMC: makeTrack('ミュートシティ', 'dMC', 154657, 'https://x.com/greeeed100111/status/2099305937186247031?s=46', 154657, ['ミュート', 'ミュートシティー']),
  ...
  dIIO: makeTrack('ツルツルツイスター', 'dIIO', 147684, 'https://www.youtube.com/watch?v=HhGzBCAE9tk', 146771, ['ツツツ', 'ツルツル', 'IIO']),
  ...
  dWW: makeTrack('ネイチャーロード', 'dWW', 147584, 'https://youtu.be/VZ7eBw_1WfM?si=sI2fOzfRTWgO3jkJ', 147584, ['ネイチャー', 'ネイチャ', 'WW']),
  dAC: makeTrack('どうぶつの森', 'dAC', 140704, 'https://youtu.be/bob_4ltzRfI?feature=shared', 140704, ['どうぶつのもり', 'どうもり', 'どう森', 'AC']),
  dNBC: makeTrack('3DS ネオクッパシティ', 'dNBC', 146187, 'https://www.youtube.com/watch?v=J2JJ2p6qjy8', 146057, ['ネオパ', 'ネオクッパ', 'ネオクッパシティ', 'NBC']),
  dRiR: makeTrack('GBA リボンロード', 'dRiR', 150701, 'https://youtu.be/J029EQKelFU?si=cleo5lmtfYWU_bEP', 150681, ['リボン', 'リボロ', 'リボンロード', 'RiR']),
  dSBS: makeTrack('リンリンメトロ', 'dSBS', 144297, 'https://youtu.be/zKrerSvMB0I', 143875, ['リンメト', 'SBS']),
  dBB: makeTrack('ビッグブルー', 'dBB', 126101, 'https://youtu.be/MRymckO9DdY?si=RqoB0elAO8CBT8SV', 125869, ['BB', 'ビックブルー']),
  bPP: makeTrack('Tour パリプロムナード', 'bPP', 151616, 'https://youtu.be/H0JHaBRq1Bs?si=qy-MDR_RPlCZ9OTg', 151220, ['パリ', 'パリプロムナード', 'PP']),
  ...
  bSG: makeTrack('GBA スカイガーデン', 'bSG', 129409, 'https://youtu.be/jddCid4UYtE', 129409, ['GBAスカイガーデン', 'グバスカ', 'GBAスカガ', 'SG']),
  bNH: makeTrack('Tour ニンニンドージョー', 'bNH', 153902, 'https://youtu.be/ZrXD1Um_Ygc?si=bP0FkOGl5ECU7gU3', 153645, ['ニンニン', 'ニンニンドージョー', 'NH']),
  bNYM: makeTrack('Tour ニューヨークドリーム', 'bNYM', 124597, 'https://youtu.be/S2h54_Sl9jM?si=M5kheBh-1jpRdaTr', 124453, ['ニューヨーク', 'ニューヨークドリーム', 'NYM', 'NY']),
  ...
  bWP: makeTrack('DS ワルイージピンボール', 'bWP', 220341, 'https://youtu.be/r6y1qY0Z-F0?feature=shared', 219740, ['ワルピン', 'ワルイージピンボール']),
  ...
  bPG: makeTrack('DS ピーチガーデン', 'bPG', 207645, 'https://youtu.be/SQMyCOuPUOk?si=MecKxHXEvtTxb1jL', 207645, ['ピチガ', 'ピーチガーデン', 'PG']),
  ...
  bRP: makeTrack('GBA リバーサイドパーク', 'bRP', 131479, 'https://youtu.be/5B69EONP1q4?feature=shared', 131279, ['リバパ', 'リバーサイドパーク', 'リバーサイド', 'リバサ', 'RP']),
  ...
  bMC: makeTrack('DS マリオサーキット', 'bMC', 141470, 'https://cdn.discordapp.com/attachments/1356631374806782203/1537394007171141652/2026071618271300-16851BE00BC6068871FE49D98876D6C5.mov?ex=6a7ee13e&is=6a7d8fbe&hm=fd582bdeae9147bb2766bdd02a465dc504669969131f1312b04faf1ec1c73fa1&', 141470, ['DSマリサ', 'DSマリオサーキット']),
  ...
  bRRw: makeTrack('Wii レインボーロード', 'bRRw', 234668, 'https://youtu.be/OtwxgpFGcNM?si=mF28hZwYUuHhDD_S', 232745, ['Wiiレインボーロード', 'Wii虹', 'Wiiにじ', 'Wiiレインボー', 'RRw']),
});
