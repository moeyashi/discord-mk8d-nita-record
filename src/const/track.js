...
const trackDict = Object.freeze({
  ...
  DS: makeTrack('ドルフィンみさき', 'DS', 156975, 'https://www.twitch.tv/videos/2229139837?t=00h22m31s', 156408, ['ドルミ']),
  ...
  bDKS: makeTrack('Wii DKスノーボードクロス', 'bDKS', 158415, 'https://youtu.be/p8Jz9si8c7g?si=9_Qig4CoyRuIoFY_', 158415, ['スノボ', 'DKスノーボードクロス', 'スノーボードクロス', 'DKS', 'DKS01', '01']),
  ...
  bSCS: makeTrack('シャボンロード', 'bSCS', 203706, 'https://youtu.be/uMafzNFUtxI', 203706, ['シャボン', 'SCS']),
