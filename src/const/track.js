...
const trackDict = Object.freeze({
  ...
  rTT: makeTrack('N64 キノピオハイウェイ', 'rTT', 147703, 'https://youtu.be/v0hnBMK_g6Q?si=YMo4YtwQ2agZru1p', 146936, ['ハイウェイ', 'キノピオハイウェイ', 'TT']),
  ...
  bKD: makeTrack('N64 カラカラさばく', 'bKD', 133624, 'https://youtu.be/4DrbbbZCo5Q', 133480, ['N64カラカラさばく', '64カラカラさばく', '64カラサバ', 'KD']),
  ...
  bWS: makeTrack('GC ワルイージスタジアム', 'bWS', 157607, 'https://youtu.be/9_8HOl0ds-8?si=HcXA7qJiNxro4A_X', 157005, ['ワルスタ', 'ワルイージスタジアム']),
