...
const trackDict = Object.freeze({
  ...
  BC: makeTrack('クッパキャッスル', 'BC', 202832, 'https://youtu.be/r9lQyn5TTNU?si=fIPMkYO9gHX-8zp0', 202250, ['クパキャ']),
  RR: makeTrack('レインボーロード', 'RR', 201161, 'https://youtu.be/CQTN8CS5v28', 201161, ['新虹', 'しんにじ', 'しん虹', '新にじ']),
  rMMM: makeTrack('Wii モーモーカントリー', 'rMMM', 127209, 'https://youtu.be/8is3VAS8qa4?si=O4fFXyAjk3kL-Js1', 127209, ['Wiiモーモーカントリー', 'モモカン', 'モーモーカントリー', 'MMM']),
  rMC: makeTrack('GBA マリオサーキット', 'rMC', 127146, 'https://www.youtube.com/watch?v=BzB5PrrhhTE', 127146, ['GBAマリオサーキット', 'グバマリ', 'GBAマリサ']),
  rCCB: makeTrack('DS プクプクビーチ', 'rCCB', 149560, 'https://youtu.be/Rde0jzOzis0?si=ktN8vMM99qcIKRY7', 149560, ['プクプクビーチ', 'プクビ', 'プクプク', 'CCB']),
  ...
  rYV: makeTrack('N64 ヨッシーバレー', 'rYV', 202926, 'https://youtu.be/lmF5SO-JqKg', 202926, ['ヨシバ', 'ヨッシーバレー', 'YV']),
  rTTC: makeTrack('DS チクタクロック', 'rTTC', 143681, 'https://www.youtube.com/watch?v=NG57bGBBnfM', 143377, ['チクタク', 'チクタクロック', 'TTC']),
  rPPS: makeTrack('3DS パックンスライダー', 'rPPS', 203237, 'https://youtu.be/Yov_bvZ0scA?si=uKRWbh_SHUJqACac', 202676, ['パクスラ', 'パックンスライダー', 'PPS']),
  ...
  dYC: makeTrack('GC ヨッシーサーキット', 'dYC', 146171, 'https://youtu.be/88OkOf_PXjQ?si=8g5ZO2jfmNj6mq85', 146171, ['ヨシサ', 'ヨッシーサーキット', 'YC']),
  ...
  dRiR: makeTrack('GBA リボンロード', 'dRiR', 150905, 'https://youtu.be/teuVy0LVZl0', 150681, ['リボン', 'リボロ', 'リボンロード', 'RiR']),
  ...
  bTB: makeTrack('Tour トーキョースクランブル', 'bTB', 127806, 'https://www.youtube.com/watch?v=9CxetJwDksI', 127522, ['東京', 'トウキョウ', 'トウキョウスクランブル', 'トーキョー', 'トーキョースクランブル', 'TB']),
  bSR: makeTrack('DS キノコリッジウェイ', 'bSR', 147948, 'https://www.youtube.com/watch?v=en1juGwAi0s', 147948, ['リッジウェイ', 'キノコリッジウェイ', 'キノコリッジ', 'リッジ', 'SR']),
  bSG: makeTrack('GBA スカイガーデン', 'bSG', 130182, 'https://youtu.be/0W4AuTvt380?feature=shared', 130182, ['GBAスカイガーデン', 'グバスカ', 'GBAスカガ', 'SG']),
  ...
  bLL: makeTrack('Tour ロンドンアベニュー', 'bLL', 212411, 'https://youtu.be/uCOu7Z0qnfs?si=HUQdLETtfM6cJ2sL', 211833, ['ロンドン', 'ロンドンアベニュー', 'アベニュー', 'LL']),
  ...
  bWS: makeTrack('GC ワルイージスタジアム', 'bWS', 158197, 'https://youtu.be/_A_lIgGRqSA?si=ZS6N1kK4jFGlPUHy', 158197, ['ワルスタ', 'ワルイージスタジアム']),
  bSSy: makeTrack('Tour シンガポールスプラッシュ', 'bSSy', 158326, 'https://youtu.be/CA7j8J8BvZE?feature=shared', 158306, ['シンガポール', 'シンガポールスプラッシュ', 'SSy']),
