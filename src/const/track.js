...
const trackDict = Object.freeze({
  ...
  bSR: makeTrack('DS キノコリッジウェイ', 'bSR', 147773, 'https://youtu.be/KxQNcJuGxfA?si=pzEfEs1sdn2AJ-at', 147773, ['リッジウェイ', 'キノコリッジウェイ', 'キノコリッジ', 'リッジ', 'SR']),
  ...
  bDKS: makeTrack('Wii DKスノーボードクロス', 'bDKS', 157358, 'https://youtu.be/PnfpKXoXxyE?si=VF-hMHRlbOnmhAsk', 156894, ['スノボ', 'DKスノーボードクロス', 'スノーボードクロス', 'DKS', 'DKS01', '01']),
