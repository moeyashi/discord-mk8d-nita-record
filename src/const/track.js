...
const trackDict = Object.freeze({
  ...
  BDD: makeTrack('ホネホネさばく', 'BDD', 151098, 'https://youtu.be/BWNzdt3_eiA', 151098, ['ホネサバ', 'ホネホネ', 'ホネホネ砂漠']),
  ...
  dMC: makeTrack('ミュートシティ', 'dMC', 154870, 'https://lite.tiktok.com/t/ZSqJstHF1/', 154859, ['ミュート', 'ミュートシティー']),
