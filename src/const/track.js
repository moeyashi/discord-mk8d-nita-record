...
const trackDict = Object.freeze({
  ...
  bTC: makeTrack('3DS キノピオサーキット', 'bTC', 124337, 'https://vt.tiktok.com/ZSNTHB93V/', 122937, ['キノサ', 'キノピオサーキット', 'TC']),
  ...
  bSR: makeTrack('DS キノコリッジウェイ', 'bSR', 147922, 'https://youtu.be/4stwmH-wxpg?si=JiDhbLcePw182-1Z', 147773, ['リッジウェイ', 'キノコリッジウェイ', 'キノコリッジ', 'リッジ', 'SR']),
  ...
  bMG: makeTrack('Wii キノコキャニオン', 'bMG', 135837, 'https://www.youtube.com/watch?v=OnyzC_FlWAA', 135829, ['キノキャニ', 'キノコキャニオン', 'MG']),
  ...
  bDKS: makeTrack('Wii DKスノーボードクロス', 'bDKS', 157358, 'https://youtu.be/PnfpKXoXxyE?si=VF-hMHRlbOnmhAsk', 157127, ['スノボ', 'DKスノーボードクロス', 'スノーボードクロス', 'DKS', 'DKS01', '01']),
