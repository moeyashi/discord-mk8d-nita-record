...
const trackDict = Object.freeze({
  ...
  rGV: makeTrack('Wii グラグラかざん', 'rGV', 154936, 'https://youtu.be/MnhtY7vyZvw?si=tqaOEq6dvHfWot6e', 158965, ['火山', 'かざん', 'グラグラ', 'グラグラ火山', 'グラグラかざん', 'GV']),
  ...
  bBL: makeTrack('GBA テレサレイク', 'bBL', 123262, 'https://youtu.be/CvQc3OaqCio?si=9GZsp6nQf_O4mPpA', 122874, ['テレレ', 'テレサレイク', 'レイク', 'BL']),
