...
const trackDict = Object.freeze({
  ...
  bTC: makeTrack('3DS キノピオサーキット', 'bTC', 123914, 'https://youtu.be/nJRMtjfVYsU?si=NJ565_NZXP6VgtMi', 123914, ['キノサ', 'キノピオサーキット', 'TC']),
  ...
  bSW: makeTrack('GBA サンセットこうや', 'bSW', 137096, 'https://youtu.be/gaxyww0xDGw?si=5e20Rgd1YCmgCoku', 136917, ['サンセット', 'こうや', 'サンセット荒野', 'サンセットこうや', 'SW']),
