...
const trackDict = Object.freeze({
  ...
  Ed: makeTrack('エレクトロドリーム', 'Ed', 200835, 'https://youtu.be/fJPQQ2FARz8?feature=shared', 200835, ['エレドリ']),
  ...
  bSG: makeTrack('GBA スカイガーデン', 'bSG', 130737, 'https://youtu.be/iPSJ011VLds?si=xtqy9uWFPnrKCWbB', 130737, ['GBAスカイガーデン', 'グバスカ', 'GBAスカガ', 'SG']),
