...
const trackDict = Object.freeze({
  ...
  TR: makeTrack('ドッスンいせき', 'TR', 152742, 'https://youtu.be/AC-wWP_5n_0', 152123, ['遺跡', 'ドッスン', 'いせき', 'ドッスン遺跡']),
  ...
  DS: makeTrack('ドルフィンみさき', 'DS', 157416, 'https://youtu.be/DBBP8_6Qkrg', 156408, ['ドルミ']),
  ...
  CC: makeTrack('スカイガーデン', 'CC', 202245, 'https://youtu.be/xs9IgBTRY5E', 201884, ['スカガ', '新スカガ']),
  ...
  rYV: makeTrack('N64 ヨッシーバレー', 'rYV', 203465, 'https://youtu.be/ofnS2zkMa_s', 202975, ['ヨシバ', 'ヨッシーバレー', 'YV']),
  ...
  dNBC: makeTrack('3DS ネオクッパシティ', 'dNBC', 146204, 'https://youtu.be/uGpm-8Ld-so', 146204, ['ネオパ', 'ネオクッパ', 'ネオクッパシティ', 'NBC']),
